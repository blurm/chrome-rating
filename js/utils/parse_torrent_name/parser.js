...
patternMap.set('quality', /(?:PPV\.)?[HP]DTV|(?:HD)?CAM|B[rRD]Rip|TS|(?:PPV )?WEB-?DL(?: DVDRip)?|H[dD]Rip|DVDRip|DVDRiP|DVDRIP|CamRip|AMZN|WEB[rR]ip|[Bb]lu[Rr]ay|DvDScr|hdtv|KORSUB/g);
...
patternMap.set('season', /([Ss]([0-9]{1,2}))/);
